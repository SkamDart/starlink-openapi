...
pub struct RouterConfigRequest {
    ...
    #[serde(rename = "routerConfigJson", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub router_config_json: Option<Option<String>>,
}

impl RouterConfigRequest {
    pub fn new() -> RouterConfigRequest {
        RouterConfigRequest {
            nickname: None,
