...
pub struct TlsConfigPublicResponseServiceResponse {
    ...
    pub content: Option<Box<models::TlsConfigPublicResponse>>,
}

impl TlsConfigPublicResponseServiceResponse {
    pub fn new() -> TlsConfigPublicResponseServiceResponse {
