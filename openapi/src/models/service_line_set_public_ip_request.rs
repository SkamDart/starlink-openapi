...
pub struct ServiceLineSetPublicIpRequest {
    /// If public IP should be enabled or not
    #[serde(rename = "publicIp")]
    pub public_ip: bool,
}

impl ServiceLineSetPublicIpRequest {
    pub fn new(public_ip: bool) -> ServiceLineSetPublicIpRequest {
