...
pub struct AccountResponsePaginatedServiceResponse {
    ...
    pub content: Option<Box<models::AccountResponsePaginated>>,
}

impl AccountResponsePaginatedServiceResponse {
    pub fn new() -> AccountResponsePaginatedServiceResponse {
