...
pub struct PartialPeriodResponseIEnumerableServiceResponse {
    ...
    pub content: Option<Option<Vec<models::PartialPeriodResponse>>>,
}

impl PartialPeriodResponseIEnumerableServiceResponse {
    pub fn new() -> PartialPeriodResponseIEnumerableServiceResponse {
