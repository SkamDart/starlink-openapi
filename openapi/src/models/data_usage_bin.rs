...
pub struct DataUsageBin {
    #[serde(rename = "dataBucket", skip_serializing_if = "Option::is_none")]
    pub data_bucket: Option<models::DataBucketType>,
    #[serde(rename = "totalGB", skip_serializing_if = "Option::is_none")]
    pub total_gb: Option<f64>,
}

impl DataUsageBin {
    pub fn new() -> DataUsageBin {
        DataUsageBin {
            data_bucket: None,
            total_gb: None,
        }
