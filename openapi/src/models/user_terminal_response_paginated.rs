...
pub struct UserTerminalResponsePaginated {
    ...
    pub results: Option<Option<Vec<models::UserTerminalResponse>>>,
    #[serde(rename = "totalCount", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<i32>,
}

impl UserTerminalResponsePaginated {
    pub fn new() -> UserTerminalResponsePaginated {
