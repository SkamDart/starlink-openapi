...
pub struct DataProductResponse {
    ...
    #[serde(rename = "dataUnit", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub data_unit: Option<Option<String>>,
}

impl DataProductResponse {
    pub fn new() -> DataProductResponse {
        DataProductResponse {
            product_id: None,
            price: None,
