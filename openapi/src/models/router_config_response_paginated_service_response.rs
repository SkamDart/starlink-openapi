...
pub struct RouterConfigResponsePaginatedServiceResponse {
    ...
    pub content: Option<Box<models::RouterConfigResponsePaginated>>,
}

impl RouterConfigResponsePaginatedServiceResponse {
    pub fn new() -> RouterConfigResponsePaginatedServiceResponse {
