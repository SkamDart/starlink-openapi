...
pub struct RouterConfigResponsePaginated {
    ...
    pub results: Option<Option<Vec<models::RouterConfigResponse>>>,
    #[serde(rename = "totalCount", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<i32>,
}

impl RouterConfigResponsePaginated {
    pub fn new() -> RouterConfigResponsePaginated {
