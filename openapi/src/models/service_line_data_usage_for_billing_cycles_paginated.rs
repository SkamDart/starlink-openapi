...
pub struct ServiceLineDataUsageForBillingCyclesPaginated {
    ...
    pub results: Option<Option<Vec<models::ServiceLineDataUsageForBillingCycles>>>,
    #[serde(rename = "totalCount", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<i32>,
}

impl ServiceLineDataUsageForBillingCyclesPaginated {
    pub fn new() -> ServiceLineDataUsageForBillingCyclesPaginated {
