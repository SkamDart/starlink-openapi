...
pub struct DataUsageResponse {
    ...
    #[serde(rename = "assetNumber", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    pub billing_cycles: Option<Option<Vec<models::DataUsageBillingCycle>>>,
    #[serde(rename = "servicePlan", skip_serializing_if = "Option::is_none")]
    pub service_plan: Option<Box<models::DataServicePlan>>,
    #[serde(rename = "lastUpdatedAt", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub last_updated_at: Option<Option<String>>,
}

impl DataUsageResponse {
    pub fn new() -> DataUsageResponse {
        DataUsageResponse {
            account_number: None,
            asset_number: None,
            start_date: None,
