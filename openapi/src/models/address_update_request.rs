...
pub struct AddressUpdateRequest {
    ...
    pub longitude: f64,
    /// Guid of the Address Reference Identifier for address. Example: 55ec6574-10d8-bd9c-1951-d4184f4ae467
    #[serde(rename = "addressReferenceId")]
    pub address_reference_id: uuid::Uuid,
}

impl AddressUpdateRequest {
    pub fn new(address_lines: Vec<String>, administrative_area_code: String, region_code: String, formatted_address: String, latitude: f64, longitude: f64, address_reference_id: uuid::Uuid) -> AddressUpdateRequest {
