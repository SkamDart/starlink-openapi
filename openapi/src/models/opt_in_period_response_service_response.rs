...
pub struct OptInPeriodResponseServiceResponse {
    ...
    pub content: Option<Box<models::OptInPeriodResponse>>,
}

impl OptInPeriodResponseServiceResponse {
    pub fn new() -> OptInPeriodResponseServiceResponse {
