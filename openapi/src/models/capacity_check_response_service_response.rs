...
pub struct CapacityCheckResponseServiceResponse {
    ...
    pub content: Option<Box<models::CapacityCheckResponse>>,
}

impl CapacityCheckResponseServiceResponse {
    pub fn new() -> CapacityCheckResponseServiceResponse {
