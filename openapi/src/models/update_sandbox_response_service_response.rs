...
pub struct UpdateSandboxResponseServiceResponse {
    ...
    pub content: Option<Box<models::UpdateSandboxResponse>>,
}

impl UpdateSandboxResponseServiceResponse {
    pub fn new() -> UpdateSandboxResponseServiceResponse {
