...
pub struct DataUsageDaily {
    #[serde(rename = "date", skip_serializing_if = "Option::is_none")]
    pub date: Option<String>,
    #[serde(rename = "dataUsageBins", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub data_usage_bins: Option<Option<Vec<models::DataUsageBin>>>,
}

impl DataUsageDaily {
    pub fn new() -> DataUsageDaily {
        DataUsageDaily {
            date: None,
            data_usage_bins: None,
        }
    }
}
