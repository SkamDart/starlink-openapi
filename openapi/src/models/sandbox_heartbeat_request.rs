...
pub struct SandboxHeartbeatRequest {
    /// True if client systems are healthy, false otherwise.
    #[serde(rename = "healthy")]
    pub healthy: bool,
}

impl SandboxHeartbeatRequest {
    pub fn new(healthy: bool) -> SandboxHeartbeatRequest {
