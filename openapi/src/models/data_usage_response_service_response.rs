...
pub struct DataUsageResponseServiceResponse {
    ...
    pub content: Option<Box<models::DataUsageResponse>>,
}

impl DataUsageResponseServiceResponse {
    pub fn new() -> DataUsageResponseServiceResponse {
