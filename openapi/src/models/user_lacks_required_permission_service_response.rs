...
pub struct UserLacksRequiredPermissionServiceResponse {
    ...
    pub content: Option<Box<models::UserLacksRequiredPermission>>,
}

impl UserLacksRequiredPermissionServiceResponse {
    pub fn new() -> UserLacksRequiredPermissionServiceResponse {
