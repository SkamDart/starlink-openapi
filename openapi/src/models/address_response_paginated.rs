...
pub struct AddressResponsePaginated {
    ...
    pub results: Option<Option<Vec<models::AddressResponse>>>,
    #[serde(rename = "totalCount", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<i32>,
}

impl AddressResponsePaginated {
    pub fn new() -> AddressResponsePaginated {
