...
pub struct RouterResponseServiceResponse {
    ...
    pub content: Option<Box<models::RouterResponse>>,
}

impl RouterResponseServiceResponse {
    pub fn new() -> RouterResponseServiceResponse {
