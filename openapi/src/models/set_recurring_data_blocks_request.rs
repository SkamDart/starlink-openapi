...
pub struct SetRecurringDataBlocksRequest {
    #[serde(rename = "recurringDataBlocks", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub recurring_data_blocks: Option<Option<Vec<models::PublicAddDataBlockRequest>>>,
}

impl SetRecurringDataBlocksRequest {
    pub fn new() -> SetRecurringDataBlocksRequest {
        SetRecurringDataBlocksRequest {
            recurring_data_blocks: None,
        }
    }
}
