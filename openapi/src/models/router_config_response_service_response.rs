...
pub struct RouterConfigResponseServiceResponse {
    ...
    pub content: Option<Box<models::RouterConfigResponse>>,
}

impl RouterConfigResponseServiceResponse {
    pub fn new() -> RouterConfigResponseServiceResponse {
