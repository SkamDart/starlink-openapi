...
pub struct ServiceLineResponseServiceResponse {
    ...
    pub content: Option<Box<models::ServiceLineResponse>>,
}

impl ServiceLineResponseServiceResponse {
    pub fn new() -> ServiceLineResponseServiceResponse {
