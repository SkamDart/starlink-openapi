...
pub struct UpdateBatchSandboxClientRequest {
...
impl UpdateBatchSandboxClientRequest {
    pub fn new(client_id: String, sandbox_id: i32, expiry: String) -> UpdateBatchSandboxClientRequest {
