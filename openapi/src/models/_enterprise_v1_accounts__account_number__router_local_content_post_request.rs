...
pub struct EnterpriseV1AccountsAccountNumberRouterLocalContentPostRequest {
    #[serde(rename = "File")]
    pub file: std::path::PathBuf,
}

impl EnterpriseV1AccountsAccountNumberRouterLocalContentPostRequest {
    pub fn new(file: std::path::PathBuf) -> EnterpriseV1AccountsAccountNumberRouterLocalContentPostRequest {
