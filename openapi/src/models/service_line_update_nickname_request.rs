...
pub struct ServiceLineUpdateNicknameRequest {
    /// New nickname for the existing service line
    #[serde(rename = "nickname")]
    pub nickname: String,
}

impl ServiceLineUpdateNicknameRequest {
    pub fn new(nickname: String) -> ServiceLineUpdateNicknameRequest {
