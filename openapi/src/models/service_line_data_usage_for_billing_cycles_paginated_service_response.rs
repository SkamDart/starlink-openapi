...
pub struct ServiceLineDataUsageForBillingCyclesPaginatedServiceResponse {
    ...
    pub content: Option<Box<models::ServiceLineDataUsageForBillingCyclesPaginated>>,
}

impl ServiceLineDataUsageForBillingCyclesPaginatedServiceResponse {
    pub fn new() -> ServiceLineDataUsageForBillingCyclesPaginatedServiceResponse {
