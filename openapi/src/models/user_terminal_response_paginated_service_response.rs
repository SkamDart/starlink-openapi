...
pub struct UserTerminalResponsePaginatedServiceResponse {
    ...
    pub content: Option<Box<models::UserTerminalResponsePaginated>>,
}

impl UserTerminalResponsePaginatedServiceResponse {
    pub fn new() -> UserTerminalResponsePaginatedServiceResponse {
