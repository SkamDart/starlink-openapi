...
pub struct AddressResponsePaginatedServiceResponse {
    ...
    pub content: Option<Box<models::AddressResponsePaginated>>,
}

impl AddressResponsePaginatedServiceResponse {
    pub fn new() -> AddressResponsePaginatedServiceResponse {
