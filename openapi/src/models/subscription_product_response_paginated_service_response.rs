...
pub struct SubscriptionProductResponsePaginatedServiceResponse {
    ...
    pub content: Option<Box<models::SubscriptionProductResponsePaginated>>,
}

impl SubscriptionProductResponsePaginatedServiceResponse {
    pub fn new() -> SubscriptionProductResponsePaginatedServiceResponse {
