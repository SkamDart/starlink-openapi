...
pub struct ServiceLineResponsePaginatedServiceResponse {
    ...
    pub content: Option<Box<models::ServiceLineResponsePaginated>>,
}

impl ServiceLineResponsePaginatedServiceResponse {
    pub fn new() -> ServiceLineResponsePaginatedServiceResponse {
