...
pub struct SubscriptionProductResponsePaginated {
    ...
    pub results: Option<Option<Vec<models::SubscriptionProductResponse>>>,
    #[serde(rename = "totalCount", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<i32>,
}

impl SubscriptionProductResponsePaginated {
    pub fn new() -> SubscriptionProductResponsePaginated {
