...
pub struct AccountResponsePaginated {
    ...
    pub results: Option<Option<Vec<models::AccountResponse>>>,
    #[serde(rename = "totalCount", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<i32>,
}

impl AccountResponsePaginated {
    pub fn new() -> AccountResponsePaginated {
